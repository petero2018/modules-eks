...
This module creates a launch template for EKS workers.
...
| [aws_ssm_parameter.aws_recommended_ami](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/ssm_parameter) | data source |
...
| <a name="output_latest_version"></a> [latest\_version](#output\_latest\_version) | Latest version of the launch template. |
